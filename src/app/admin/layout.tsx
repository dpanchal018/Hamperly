...
import { Package, Calendar, Folder, LayoutDashboard, Image as ImageIcon, Settings, Star } from 'lucide-react';
    ...
    <div className="flex h-screen bg-slate-50 text-slate-900 font-sans selection:bg-rose-200">
      ...
      <aside className="w-64 bg-white/80 backdrop-blur-xl border-r border-slate-200 flex flex-col shadow-sm relative z-20">
        ...
        <nav className="flex-1 px-4 space-y-1.5 mt-2">
          ...
          <Link href="/admin/reviews" className="flex items-center px-4 py-2.5 text-sm font-medium text-slate-600 rounded-lg hover:bg-indigo-50 hover:text-indigo-700 transition-colors duration-200">

  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button 
        ...
        className="flex items-center justify-center w-9 h-9 rounded-full bg-rose-600 hover:bg-rose-700 text-white font-semibold transition-colors ring-2 ring-rose-100 shadow-sm"
        title={fullName}
      >
        {initials}
      </button>
